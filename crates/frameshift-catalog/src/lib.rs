//! # frameshift-catalog
//!
//! Canonical async trait and types for the frameshift persona marketplace catalog.
//!
...
//! ## Adapter crates
//!
//! The Postgres adapter lives in `frameshift-catalog-postgres` and implements
...
pub use records::{
    ...
    AccountMfaEnrollmentRequest, AccountMfaLoginChallengeRecord, AccountMfaRecoveryCodeSeed,
    AccountPasswordCredentialRecord, AccountPasswordRehashRequest, AccountRecord,
    AccountSessionClientKind, AccountSessionCreationRequest, AccountSessionIssuance,
    AccountSessionRecord, AccountSessionRefreshRequest, AccountSessionRefreshResult, AccountStatus,
    AccountStatusChangeRequest, AuthorRecord, EncryptedPasswordRecoveryDelivery,
    EncryptedTotpSecret, LocalAccountRegistrationRequest, LocalAccountRegistrationResult,
    ...
    NativeAuthorizationCodeRecord, OauthLink, PackRecord, PackVersionRecord,
